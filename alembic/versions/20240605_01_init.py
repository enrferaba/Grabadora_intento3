...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("transcription_seconds", sa.Numeric(scale=2), nullable=False, server_default="0"),
        sa.Column("transcription_cost", sa.Numeric(scale=4), nullable=False, server_default="0"),

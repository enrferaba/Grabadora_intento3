...
def encode_jwt(payload: Mapping[str, object], secret: str, *, algorithm: str = "HS256") -> str:
    if algorithm != "HS256":
...
def decode_jwt(token: str, secret: str, *, algorithms: Iterable[str] | None = None) -> dict:
